...
from cabot.cabotapp.views import (
        ...
        ScheduleDetailView, ScheduleListView, ScheduleUpdateView,
        ScheduleDeleteView
)
...
urlpatterns = patterns('',
    ...
    url(r'^shifts/(?P<pk>\d+)/', view=ShiftListView.as_view(), name='shifts-pk'),
    ...
    url(r'^schedule/(?P<pk>\d+)/', view=ScheduleDetailView.as_view(), name='schedule'),
