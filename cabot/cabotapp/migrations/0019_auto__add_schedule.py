...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cabotapp_schedule', (
            ...
            ('name', self.gf('django.db.models.fields.TextField')(default='Main')),
            ('feed_url', self.gf('django.db.models.fields.TextField')(default='https://affirm.pagerduty.com/schedules#PW4LM7V')),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'cabotapp_schedule')
