...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.schedule'
        db.add_column(u'cabotapp_instance', 'schedule',
    ...
    def backwards(self, orm):
        # Deleting field 'Instance.schedule'
        db.delete_column(u'cabotapp_instance', 'schedule_id')

        # Deleting field 'Shift.schedule'
        db.delete_column(u'cabotapp_shift', 'schedule_id')

        # Deleting field 'Service.schedule'
        db.delete_column(u'cabotapp_service', 'schedule_id')
    ...
    models = {
        ...
        u'cabotapp.schedule': {
            ...
            'feed_url': ('django.db.models.fields.TextField', [], {'default': "'https://affirm.pagerduty.com/schedules#PW4LM7V'"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {'default': "'Main'"})
        },
        u'cabotapp.service': {
